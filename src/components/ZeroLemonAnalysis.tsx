...
const routeConcepts: RouteConceptProps[] = [
  ...
  },
  {
    ...
    halftimeAdjustment: -12,
  },
];

const halftimeWeather = {
  temp: 28,
  wind: 18,
  windDirection: "NW",
  humidity: 58,
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <div className="bg-strata-steel/20 rounded p-2 text-center">
                ...
                <div className="font-instrument text-lg text-strata-blue">{halftimeWeather.wind} mph</div>
              </div>
              <div className="bg-strata-steel/20 rounded p-2 text-center">
                <div className="text-[9px] font-mono text-strata-silver/50 uppercase mb-1">Temp</div>
                <div className="font-instrument text-lg text-strata-cyan">{halftimeWeather.temp}°F</div>
              </div>
              <div className="bg-strata-steel/20 rounded p-2 text-center">
                <div className="text-[9px] font-mono text-strata-silver/50 uppercase mb-1">Field</div>
                <div className="font-instrument text-xs text-strata-orange">Frozen</div>
              </div>
            </div>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gradient-to-b from-strata-charcoal to-strata-black border-strata-steel/30">
        ...
        <div className="mt-6 p-4 rounded-lg border border-strata-steel/30 bg-strata-steel/10">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="ml-auto text-[10px] font-mono text-strata-lume px-2 py-0.5 rounded bg-strata-lume/10">
              Live
            </span>
          </div>
          <div className="grid grid-cols-5 gap-3">
            <div className="text-center p-3 rounded bg-strata-black/50">
              ...
              <div className="font-instrument text-xl text-strata-white">{halftimeWeather.temp}°F</div>
            ...
            <div className="text-center p-3 rounded bg-strata-black/50">
              ...
              <div className="font-instrument text-xl text-strata-white">{halftimeWeather.wind}</div>
              <div className="text-[9px] font-mono text-strata-silver/50 uppercase">MPH {halftimeWeather.windDirection}</div>
            </div>
            <div className="text-center p-3 rounded bg-strata-black/50">
              <Zap className="w-4 h-4 mx-auto text-strata-orange mb-2" />
              <div className="font-instrument text-xl text-strata-white">{halftimeWeather.humidity}%</div>
            ...
            <div className="text-center p-3 rounded bg-strata-black/50 col-span-2">
              ...
              <div className="font-instrument text-lg text-strata-orange">{halftimeWeather.fieldCondition}</div>
        ...
        <div className="mt-6 p-4 rounded-lg border border-strata-steel/30 bg-strata-steel/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-mono text-strata-lume">Short Routes +12%</span>
              </div>
              <div className="flex items-center gap-2">
                <Shuffle className="w-3.5 h-3.5 text-strata-red" />
                <span className="text-[11px] font-mono text-strata-red">Deep Routes −8%</span>
              </div>
            </div>
          </div>
          ...
          <div className="h-4 rounded-full bg-strata-steel/30 overflow-hidden flex">
            <div className="h-full bg-strata-lume transition-all" style={{ width: "35%" }} title="Slant" />
            <div className="h-full bg-strata-cyan transition-all" style={{ width: "25%" }} title="Hitch" />
            <div className="h-full bg-strata-orange transition-all" style={{ width: "20%" }} title="Out" />
            <div className="h-full bg-patriots-red transition-all" style={{ width: "12%" }} title="Whip" />
            <div className="h-full bg-strata-silver/40 transition-all" style={{ width: "8%" }} title="Seam" />
          </div>
        ...
        <div className="mt-6 p-4 rounded border border-patriots-red/30 bg-gradient-to-r from-patriots-red/10 to-transparent">
          <p className="text-sm">
            ...
            <span className="text-strata-silver/80 ml-2">
              Second-half weather deterioration favors quick-timing routes. Recommend increasing Slant/Hitch frequency by 15% while reducing vertical concepts. Wind direction shift to NW benefits Patriots' offensive positioning.
            </span>
          </p>
        </div>
      </DialogContent>
