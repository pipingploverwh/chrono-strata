  ...
  stories: [
    {
      ...
      acceptanceCriteria: [
        ...
        'Flight rule classification (VFR/MVFR/IFR)',
      ],
      status: 'done',
      priority: 'ship',
      points: 8,
      ...
      tags: ['b2b', 'weather', 'priority', 'shipped'],
    ...
    },
    {
      ...
      acceptanceCriteria: [
        'Image & PDF upload works (up to 10MB)',
        'OCR extracts text via Lovable AI (Gemini)',
        'Validation errors display with visual feedback',
        'Extracted text editable before use',
      ...
      apiContract: {
        endpoint: '/ai-ocr',
        method: 'POST',
        request: { imageBase64: 'string (data URL)' },
        response: { text: 'string' },
      },
      tags: ['b2b', 'ai', 'ocr', 'shipped'],
      createdAt: '2026-01-20',
      updatedAt: '2026-01-26',
    },
    {
      ...
      acceptanceCriteria: [
        ...
        'Voice selector dropdown with Professional/Casual/Urgent styles',
      ],
      status: 'done',
      priority: 'ship',
      points: 3,
